...
**Data Understanding,Cleaning & Preprocessing**: Handle missing values (if any)  and Feature scaling for Amount
...
**Exploratory Data Analytics (EDA)**: Analyze class imbalance and Visualizations for fraud trends  
